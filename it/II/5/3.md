...
Per capire come funziona questa <b>discriminazione basata su caratteristiche osservabili</b>, prendiamo ancora una volta i dati della Figura 5.6, supponendo che esistano due gruppi di consumatori ugualmente numerosi (500 individui ciascuno): gli adulti (gruppo A), ciascuno con disponibilità a pagare come nel pannello di sinistra della figura qui sotto, e i giovani (gruppo B), con una disponibilità a pagare più bassa (pannello di destra della figura).
