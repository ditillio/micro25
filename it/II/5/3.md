...
Riprendiamo l'esempio della Figura 5.6, in cui ogni unità rappresenta un biglietto della metropolitana. Alice è disposta a pagare 8 euro per il primo biglietto, 7 per il secondo, e così via fino a 1 euro per l'ottavo. Bruno è disposto a pagare 4 euro per il primo biglietto, 3 per il secondo, 2 per il terzo, e 1 per il quarto. Se il prezzo unitario è fissato al costo marginale ($1.50$ euro), Alice acquista quindi 7 biglietti, mentre Bruno ne acquista 3. Il surplus che Alice riceverebbe pagando solo il prezzo unitario è
...
Il monopolista può quindi chiedere una quota d’accesso di 24.50 euro ad Alice, e una di 4.50 a Bruno, oltre al pagamento di 1.50 euro per ciascun biglietto. Il profitto totale sarà $24.50+4.50=29$ euro, come nella discriminazione perfetta.
...
Tornando all’esempio dei biglietti della metropolitana (Figura 5.6), sappiamo che Alice è disposta a pagare in totale 35 euro per 7 biglietti, e Bruno è disposto a pagare 9 euro per 3 biglietti. Il monopolista può semplicemente offrire ad Alice un pacchetto da 7 biglietti al prezzo di 35 euro, e a Bruno un pacchetto da 3 biglietti al prezzo di 9 euro. Il ricavo del monopolista è 44 euro, il costo $10 \times 1.5 = 15$ euro, quindi il profitto è 29 euro: lo stesso risultato della tariffa a due parti.
...
Abbiamo dunque Alice, che è disposta a pagare 8 euro per il primo biglietto, 7 per il secondo, e così via, e Bruno, che è disposto a pagare 4 euro per il primo biglietto, 3 per il secondo, e così via. Nella Figura 5.6 abbiamo visto che, applicando un prezzo lineare uguale per tutti, il massimo profitto che il monopolista può ottenere è 15 euro, mentre se può discriminare perfettamente, il massimo profitto è 29 euro. Quanto profitto può ottenere se può offrire tariffe nonlineari, ma non sa distinguere Alice da Bruno?

Una possibilità è offrire un pacchetto da 7 biglietti a 35 euro e uno da 3 biglietti a 9 euro, come nella discriminazione perfetta. Ma questa non è una buona idea. Così facendo, il monopolista indurrebbe non solo Bruno, ma <i>anche Alice</i> a scegliere il pacchetto da 3 biglietti. Infatti Alice preferisce pagare 9 euro per 3 biglietti, che per lei valgono $8+7+6=21$ euro, a pagarne 35 per 7. Nel primo caso il suo surplus è $21-9=12$, nel secondo è zero. Il profitto del monopolista sarebbe quindi molto basso: $9+9-2\times(3+3)=6$.

Per fare più profitto, il monopolista deve ridurre l’attrattiva del pacchetto pensato per Bruno, in modo da poter alzare il prezzo del pacchetto pensato per Alice. Supponiamo di offrire un pacchetto da 2, anziché 3 biglietti, a 7 euro (quanto Bruno è disposto a pagare per due biglietti). Questa opzione adesso è meno allettante per Alice: se la scegliesse, otterrebbe un surplus pari al suo valore complessivo per due biglietti ($8+7=15$) meno 7, cioè 8. Per fare
<span class="marginnote">
La tariffa nonlineare che stiamo descrivendo qui <i>migliora</i> il profitto del monopolista rispetto al caso di prezzo lineare uguale per tutti, ma non è quella che <i>massimizza</i> il profitto. In questo esempio, la tariffa nonlineare ottima per il monopolista consiste nell'escludere completamente Bruno e offrire solo un pacchetto da 7 biglietti a 35 euro. In questo modo solo Alice compra, e il monopolista ottiene un profitto pari a $35-1.50\times 7=24.50$.
</span>
in modo che Alice compri il pacchetto da 7 biglietti, possiamo allora fissare il prezzo di quel pacchetto in modo che ad Alice resti almeno un surplus di 8. Il valore complessivo per i primi 7 biglietti per lei è 35, quindi possiamo vendere il pacchetto da 7 a 27 euro. A questo punto Alice sceglie “7 a 27”, Bruno sceglie “2 a 7”. Il ricavo totale è $27+7=34$ mente i costi sono $1.50$ per biglietto, quindi $1.50\times 9=13.5$ in totale. Il profitto è $34−13.5 = 20.5$, meglio del profitto senza discriminazione di 15.
...
Per capire come funziona questa <b>discriminazione basata su caratteristiche osservabili</b>, consideriamo un esempio simile a quello della Figura 5.6, supponendo che esistano due gruppi di consumatori ugualmente numerosi (500 individui ciascuno): gli adulti (gruppo A), ciascuno con disponibilità a pagare come nel pannello di sinistra della figura qui sotto, e i giovani (gruppo B), con una disponibilità a pagare più bassa (pannello di destra della figura).
