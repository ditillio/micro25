...
Una delle implicazioni più importanti del comportamento del monopolista riguarda il **markup** o <b>indice di Lerner</b>, ovvero la differenza tra prezzo e costo marginale, in rapporto al prezzo:
...
è molto elastica, il markup è basso: il monopolista non può aumentare troppo il prezzo senza perdere una grande quantità di vendite. Se la domanda è rigida, il markup è alto: il monopolista può alzare il prezzo senza ridurre significativamente la quantità venduta. Questo spiega perché i prezzi siano spesso elevati in settori in cui i consumatori hanno poche alternative o non possono rinunciare all'acquisto (e viceversa perché siano più bassi in mercati per es. con alta concorrenza da parte di prodotti simili).
