...
Nel mercato degli smartphone dei primi anni 2000 la domanda era molto elastica. I progressi tecnologici ridussero i costi, le vendite esplosero e i profitti crebbero. I primi cellulari costavano migliaia di euro per funzioni basiche; pochi anni dopo, con molto meno si potevano comprare smartphone con capacità molto superiori. Oggi il mercato è maturo e saturo, e la domanda più rigida: quasi tutti possiedono uno smartphone, così ulteriori riduzioni di costo spingono i prezzi verso il basso mentre le quantità aumentano poco (in realtà solo i modelli <i>base</i> sono più economici — il prezzo medio rimane alto perché le imprese puntano a vendere modelli più avanzati).
</span>

<span class="marginnote"><img src="FordT.png">
Lo stesso vale per le automobili. Con la produzione di massa di inizio Novecento la domanda era elastica: milioni di famiglie entrarono nel mercato e i profitti salirono. La Ford T, che inizialmente costava più di due anni di salario di un operaio, divenne accessibile in meno di un anno grazie alle catene di montaggio. Oggi il mercato è saturo e la domanda più rigida.
</span>
